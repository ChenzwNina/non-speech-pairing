...
probes that shaped it; **laughter_sigh_contrast_v3** is the benchmark they led to,
...
| **[laughter_sigh_contrast_v3](laughter_sigh_contrast_v3/)** | The same conversation heard three ways — plain, through laughter, through sighs — with the words held **physically identical**. Two generations: [1.0](laughter_sigh_contrast_v3/1.0/) and [2.0](laughter_sigh_contrast_v3/2.0/). | 20 items × 3 × 4 models, four evals |
...
Start with [laughter_sigh_contrast_v3/2.0/PIPELINE.md](laughter_sigh_contrast_v3/2.0/PIPELINE.md) — it describes how the current dataset is built,
